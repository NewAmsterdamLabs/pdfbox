...
/**
 * This class has been copied from Apache PDFBox 3.0.4 and modified to support the GSUB lookup types 3:
...
public class GsubWorkerFactory {
    ...
    public GsubWorker getGsubWorker(CmapLookup cmapLookup, GsubData gsubData) {
        ...
        switch (gsubData.getLanguage()) {
            ...
            case LATIN:
            case DFLT:
                // TODO: We need to implement a proper GsubWorker for DEFAULT language
